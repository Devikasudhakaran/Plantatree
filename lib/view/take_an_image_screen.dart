...
import 'package:plantatree/controller/take_an_image_screen_controller.dart';
...
class _ImageTakerState extends State<ImageTaker> {
  ImageUploadController imageUploadController = ImageUploadController();
  File? _captureimage;
  ...
  Future _takePicture() async {
    ...
    setState(() {
      _captureimage = File(capture.path);
    });

    if (_captureimage != null)
      await imageUploadController.uploadImage(widget.userid, _captureimage);
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: _isLoading
                                  ? Loadingwidget(
                                      color: const Color(0xFF497a39), size: 20)
                                  : GoogleFont(
                                      text: "Submit",
                                      fontSize: 24,
                                      color: Colors.white,
